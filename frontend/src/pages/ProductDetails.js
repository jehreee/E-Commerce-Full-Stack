        ...
        {/**product detail */}
        {
          loading ? (
            <div className='grid gap-1 w-full'>
              <p className='bg-slate-200 animate-pulse h-4 lg:h-8 w-full rounded-full inline-block '></p>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1'>
                  <p className='text-red-600'>{displayNGNCurrency(data.sellingPrice)}</p>
                  <p className='text-slate-400 line-through'>{displayNGNCurrency(data.price)}</p>
                </div>
